...
<fieldset style="width: 750px;background-color: darkred;color: white">
	<legend style="color: yellow;background-color: silver;border-radius: 14px">Candidates for Human Resource Post</legend>
...
//if (isset($_GET['PostId'])) {
	...
	FROM candidatesresult INNER JOIN post ON  candidatesresult.PostId=post.PostId WHERE post.PostName='hr' order by Marks Desc";
